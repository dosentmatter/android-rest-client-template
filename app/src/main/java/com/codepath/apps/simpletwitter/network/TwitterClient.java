...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "B5l7PouVDCTXxGYP0FHDAEft2";
    public static final String REST_CONSUMER_SECRET
        = "4hGFRo5CVrfqdJSaxgt4Pn6LWIfzKnXQTVJI8RkBngPEm4crFL";
    ...
    public void getCurrentUserInfo(RequestParams params,
                                   AsyncHttpResponseHandler handler) {
        String apiUrl = getApiUrl("account/verify_credentials.json");
        client.get(apiUrl, params, handler);
    }

    public void postUpdate(RequestParams params,
                           AsyncHttpResponseHandler handler) {
     ...
     *    endpoint i.e getApiUrl("statuses/home_timeline.json");
